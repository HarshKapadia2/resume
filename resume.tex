    ...
    \begin{itemize}[leftmargin=0.2in, label={}]
        {\item{
            \begin{tabular}{ l@{\hskip 0.2in} l }
                 \textbf{Web}: React.js, Node.js (Express.js), Flask, HTML, CSS, JS & \textbf{Languages}: JavaScript, Java \\ 
                 \textbf{Databases}: MySQL, MongoDB & \textbf{Platforms}: GitHub, Firebase, Heroku, Deta \\  
                 \textbf{Tools}: Git, \href{https://harshkapadia2.github.io/asciidoctor-jet}{Asciidoctor Jet}, Adobe Illustrator, Figma & \textbf{Mobile}: React Native
            \end{tabular}
        }}
    \end{itemize}
\vspace{-22pt}
    ...
    \resumeSubHeadingListStart
        \resumeSubheading
            ...
            \resumeItemListStart
                ...
                \resumeItem{\href{https://ourtech.community}{ourtech.community} $|$ \href{https://catchup.ourtech.community}{OTC CatchUp} $|$ \href{https://ourtech.community/two-years}{Two years of OTC}}
            \resumeItemListEnd
        \vspace{-2pt}
