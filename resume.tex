...
\section{Projects}
    ...
    \resumeSubHeadingListStart
        \resumeProjectHeading
            {\textbf{\large{Git Graph}} $|$ \emph{React.js, GitHub Pages}}{Jan 2022 -- present}
            \resumeItemListStart
                \resumeItem{A web app to visualize how Git connects \href{https://git.harshkapadia.me/\#_git_objects}{Commit, Tree and Blob objects} internally.}
                \resumeItem{Takes an existing repository and generates the Directed Acyclic Graph that Git uses to connect objects internally.}
                \resumeItem{\href{https://harshkapadia2.github.io/git-graph}{Web app} $|$ \href{https://github.com/HarshKapadia2/git-graph}{GitHub}}
            \resumeItemListEnd
        \vspace{-19pt}

        \resumeProjectHeading
            {\textbf{\large{git\_basics}} $|$ \emph{Asciidoctor Jet, GitHub Pages}}{Mar 2020 -- present}
            \resumeItemListStart
...
\section{Community Activity}
    \resumeSubHeadingListStart
        \resumeSubheading
            ...
            \vspace{-7pt}
            \resumeItemListStart
                \resumeItem{A Tech-loving open-to-all community that I started.}
                \resumeItem{\textbf{Hosted over 500 hours of weekly \href{https://catchup.ourtech.community}{OTC CatchUp} sessions since Oct 2020} involving technical discussions, project showcases and talks.}
                \resumeItem{\textbf{Organised an in-person \href{https://meetup.ourtech.community}{OTC MeetUp} event with 60+ attendees.}}
        ...
        \resumeSubheading
            ...
            \vspace{-18pt}
            \resumeItemListStart
                \resumeItem{\textbf{Impacted over 700 people} in more than 16 talks and workshops at various technical meetups on Git and GitHub.}
...
\section{Extracurricular Activity}
    \resumeSubHeadingListStart
        \resumeSubheading
            ...
            \resumeItemListStart
                \resumeItem{\textbf{Organised three hackathons}, TSEC Hacks 2020, 2021 and 2022. (\href{https://blog.harshkapadia.me/2022/hackathon-team-attitude}{Learnings})}
