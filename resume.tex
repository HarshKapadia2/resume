...
\begin{center}
    ...
    \small
    \faGlobe \href{httos://harshkapadia.me}{\raisebox{-0.1\height}\ harshkapadia.me} ~
...
\section{Education}
  \resumeSubHeadingListStart
    \resumeSubheading
        {University of Mumbai (Thadomal Shahani Engineering College)}{2018 -- 2022 (exp)}
        {Bachelor of Engineering in Information Technology (CGPA: 8.91/10)}{Mumbai, India}
...
\section{Skills}
    ...
    {\item{
        \textbf{Web}: React.js, Node.js (Express.js), Flask, HTML, CSS, JS \\
        \textbf{Databases}: MySQL, MongoDB \\
        \textbf{Platforms}: GitHub, Firebase, Heroku \\
        \textbf{Tools}: Git, Adobe Illustrator, Figma \\
...
\section{Experience}
    \resumeSubHeadingListStart
        \resumeSubheading
            {NanoNet Technologies Inc.}{Aug 2021 - present}
            {Software Intern}{}
            \resumeItemListStart
                \resumeItem{Migrated API specification from Swagger 2.0 to OpenAPI 3.1.0.}
...
\section{Projects}
    ...
    \resumeSubHeadingListStart
        \resumeProjectHeading
            {\textbf{git\_basics} $|$ \emph{Asciidoctor, CSS, JS, GitHub Pages}}{Mar 2020 -- present}
            \resumeItemListStart
                \resumeItem{A PWA and TWA for Git and GitHub concepts and commands.}
                \resumeItem{Explains the internal working of Git.}
                \resumeItem{\textbf{500+ installs on Google Play and 80+ stars on GitHub.}}
        ...
        \resumeProjectHeading
            ...
            \resumeItemListStart
                ...
                \resumeItem{Uses the Fetch API and the Web Components API.}
        ...
        \resumeProjectHeading
            ...
            \resumeItemListStart
                \resumeItem{Renders GitHub-styled markdown live.}
    ...
    \resumeSubHeadingListStart
        ...
        \resumeSubheading
            ...
            \resumeItemListStart
                ...
                \resumeItem{\textbf{Hosted weekly OTC CatchUp sessions since Oct 2020} involving project showcases and technical discussions.}
                \resumeItem{\href{https://ourtech.communtiy}{Web site} $|$ \href{https://catchup.ourtech.community}{OTC CatchUp}}
            \resumeItemListEnd
