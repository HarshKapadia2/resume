...
\section{Projects}
    ...
    \resumeSubHeadingListStart
        \resumeProjectHeading
            ...
            \resumeItemListStart
                \resumeItem{A web app to visualize the Directed Acyclic Graph (DAG) that Git uses to connect \href{https://git.harshkapadia.me/\#_git_objects}{Commit, Tree and Blob objects}.}
                \resumeItem{Takes an existing repository to generate DAG visualizations for local branches and allows highlighting specific commits.}
            \resumeItemListEnd
        \vspace{-19pt}

        \resumeProjectHeading
            {\textbf{\normalsize{Git Internals}} $|$ \emph{\href{https://harshkapadia2.github.io/asciidoctor-jet}{Asciidoctor Jet}, GitHub Pages} $|$ \href{https://git.harshkapadia.me}{PWA}, \href{https://github.com/HarshKapadia2/git_internals}{GitHub}}{May 2020 -- present}
            \resumeItemListStart
        ...
        \resumeProjectHeading
            {\textbf{\normalsize{OTC CatchUp}} $|$ \emph{HTML, CSS, JS, \href{https://harshkapadia2.github.io/asciidoctor-jet}{Asciidoctor Jet}, Shell, Deta} $|$ \href{https://catchup.ourtech.community}{Web app}, \href{https://github.com/OurTechCommunity/catchup}{GitHub}}{Sep 2021 -- present}
            \resumeItemListStart
                \resumeItem{Created a web app for managing weekly \href{https://catchup.ourtech.community}{OTC CatchUp} Tech discussion sessions.}
                \resumeItem{Hosts session summaries created using \href{https://harshkapadia2.github.io/asciidoctor-jet}{Asciidoctor Jet} and manages session joining links using Deta Base.}
...
\section{Extracurricular Activity}
    ...
    \resumeSubHeadingListStart
        \resumeSubheading
            ...
            \vspace{-18pt}
            \resumeItemListStart
                \resumeItem{Organised three editions of TSEC CodeCell's \href{https://www.tseccodecell.com/tsec-hacks}{TSEC Hacks} (2020-22) with 200+ in-person participants. (\href{https://blog.harshkapadia.me/2022/hackathon-team-attitude}{Learnings})}
