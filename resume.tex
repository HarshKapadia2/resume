    ...
    \begin{itemize}[leftmargin=0.2in, label={}]
        {\item{
            \begin{tabular}{ l@{\hskip 0.2in} l@{\hskip 0.2in} l@{\hskip 0.2in} l@{\hskip 0.2in} l }
                 \textbf{Qualification} & \textbf{College} & \textbf{University} & \textbf{CGPA} & \textbf{Year} \\ 
                 MS in CS & The Graduate School of Arts \& Sciences & Boston University & - & 2024 (exp) \\
                 BE in IT & Thadomal Shahani Engineering College & University of Mumbai & 9.02/10 & 2022
            \end{tabular}
        }}
    \end{itemize}
\vspace{-20pt}
    ...
    \begin{itemize}[leftmargin=0.2in, label={}]
        {\item{
            \begin{tabular}{ l@{\hskip 0.2in} l }
                 ...
                 \textbf{Tools}: Git, \href{https://harshkapadia2.github.io/asciidoctor-jet}{Asciidoctor Jet}, Figma & \textbf{CI/CD}: GitHub Actions
            \end{tabular}
        }}
    \end{itemize}
\vspace{-22pt}
...
\section{Projects}
    ...
    \resumeSubHeadingListStart
        \resumeProjectHeading
            {\textbf{\normalsize{Git Graph}} $|$ \emph{React.js, GitHub Pages}}{Jan 2022 -- present}
            \resumeItemListStart
                ...
                \resumeItem{\href{https://git-graph.harshkapadia.me}{Web app} $|$ \href{https://github.com/HarshKapadia2/git-graph}{GitHub}}
            \resumeItemListEnd
        \vspace{-19pt}

        \resumeProjectHeading
            {\textbf{\normalsize{Git Internals}} $|$ \emph{\href{https://harshkapadia2.github.io/asciidoctor-jet}{Asciidoctor Jet}, GitHub Pages}}{May 2020 -- present}
            \resumeItemListStart
                ...
                \resumeItem{\href{https://git.harshkapadia.me}{PWA} $|$ \href{https://github.com/HarshKapadia2/git_internals}{GitHub}}
            \resumeItemListEnd
        \vspace{-19pt}

        \resumeProjectHeading
            {\textbf{\normalsize{HPS Gems}} $|$ \emph{HTML, CSS, JS, PHP, MySQL, Heroku}}{Oct 2020 -- Dec 2020}
            \resumeItemListStart
        ...
        \resumeProjectHeading
            {\textbf{\normalsize{Preview Markdown}} $|$ \emph{React.js, CSS, JS, GitHub Pages}}{Jun 2021}
            \resumeItemListStart
                \resumeItem{A web app that renders GitHub-styled markdown live.}
                \resumeItem{Supports GitHub's light and dark themed Markdown rendering.}
...
\section{Community Activity}
    ...
    \resumeSubHeadingListStart
        \resumeSubheading
            ...
            \vspace{-7pt}
            \resumeItemListStart
                \resumeItem{Started a Tech-loving open-to-all community with 380+ current members.}
                \resumeItem{Hosted over 500 hours of weekly \href{https://catchup.ourtech.community}{OTC CatchUp} sessions since Oct 2020 involving technical discussions, project showcases and talks.}
        ...
        \resumeSubheading
            ...
            \vspace{-18pt}
            \resumeItemListStart
                \resumeItem{Impacted over 700 people in more than 16 talks and workshops at various technical meetups.}
                \resumeItem{\href{https://talks.harshkapadia.me}{talks.harshkapadia.me} $|$ \href{https://www.youtube.com/HarshKapadia}{YouTube}}
            \resumeItemListEnd
        \vspace{-4pt}
