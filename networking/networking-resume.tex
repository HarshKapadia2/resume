    ...
    \begin{itemize}[leftmargin=0.2in, label={}]
        {\item{
            \begin{tabular}{ l@{\hskip 0.2in} l }
                 \textbf{Tools}: Wireshark, Tcpdump, Git & \textbf{Languages}: Python (Scapy), C, Java, JavaScript \\ 
                 \textbf{Platforms}: GENI, GitHub, Firebase & \textbf{Databases}: MySQL, MongoDB \\  
                 \textbf{Web}: React.js, Node.js, HTML, CSS, JS
            \end{tabular}
        }}
    \end{itemize}
\vspace{-20pt}
