    ...
    \begin{itemize}[leftmargin=0.2in, label={}]
        {\item{
            \begin{tabular}{ l@{\hskip 0.2in} l }
                 \textbf{Tools}: Wireshark, Tcpdump, Vim, Git & \textbf{Languages}: Python (Scapy), C, Bash, Java, JavaScript \\ 
                 \textbf{Testbeds}: GENI, CloudLab & \textbf{Databases}: MySQL, MongoDB \\  
                 \textbf{Web}: React.js, Node.js, HTML, CSS, JS & \textbf{Platforms}: GitHub, Firebase
            \end{tabular}
        }}
    \end{itemize}
\vspace{-20pt}
