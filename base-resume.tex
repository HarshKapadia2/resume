    ...
    \begin{itemize}[leftmargin=0.2in, label={}]
        {\item{
            \begin{tabular}{ l@{\hskip 0.2in} l }
                 ...
                 \textbf{Tools}: Git, iperf3, Wireshark, Tcpdump, Vim & \textbf{CI/CD}: GitHub Actions
            \end{tabular}
        }}
    \end{itemize}
\vspace{-20pt}
    ...
    \resumeSubHeadingListStart
        \resumeSubheading
            ...
            \resumeItemListStart
                ...
                \resumeItem{Benchmarking network bandwidth (iperf3), memory bandwidth (STREAM) and CPU performance (DGEMM) of servers.}
            \resumeItemListEnd
